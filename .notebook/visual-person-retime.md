...
Target-duration constraint: normal-speed duration must be below requested final duration; distribute remaining duration proportionally across fast ranges.
